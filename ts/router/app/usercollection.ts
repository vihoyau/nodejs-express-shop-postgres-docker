...
// 用户参加活动
router.post('/useractivity', checkAppLogin, async function (req: Request, res: Response, next: NextFunction) {
...
//收集卡牌
router.post('/userjoinactivity', checkAppLogin, async function (req: Request, res: Response, next: NextFunction) {
    let { Activityuuid } = (req as any).body
    try {
        const info: LoginInfo = (req as any).loginInfo
        // if (!info.isAppUser())
...
//帮我收藏卡牌
router.post('/helpothercollection', checkAppLogin, async function (req: Request, res: Response, next: NextFunction) {
    //UserId是用户发出链接的用户id
...
//查看用户出生年份
router.get('/userbirthday/:Activityuuid', checkAppLogin, async function (req: Request, res: Response, next: NextFunction) {
    try {
        let Activityuuid = req.params["Activityuuid"];
...
//领取奖励
router.post('/getreward', checkAppLogin, async function (req: Request, res: Response, next: NextFunction) {
    try {
...
//查看活动crm记录
router.get('/getrewardinfo/:Activityuuid', checkAppLogin, async function (req: Request, res: Response, next: NextFunction) {
    try{
    let  Activityuuid  = req.params["Activityuuid"];
    // let Activityuuid = req.params["Activityuuid"];
...
router.get('/getuserinfo/:Activityuuid/:useruuid', async function (req: Request, res: Response, next: NextFunction) {
